...
public class FileEncryptor {
    ...
    public static void main(String[] args) throws NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException, InvalidAlgorithmParameterException, IOException {
        ...
        final Path encryptedPath = tempDir.resolve("TestPresentation.pptx.encrypted");
        try (InputStream fin = FileEncryptor.class.getResourceAsStream("TestPresentation.pptx");
        ...
        final Path decryptedPath = tempDir.resolve("TestPresentation.pptx");
