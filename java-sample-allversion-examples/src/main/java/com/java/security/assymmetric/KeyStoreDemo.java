...
public class KeyStoreDemo {
    ...
    /*
     * Command to open the keystore in command prompt
     * keytool -list -keystore C:\Users\SG4F03~1.MUR\AppData\Local\Temp\keystore10848299164616556807.jks
     * 
     * Migrate to PKCS12
     * keytool -importkeystore -srckeystore C:\Users\SG4F03~1.MUR\AppData\Local\Temp\keystore10848299164616556807.jks -destkeystore C:\Users\SG4F03~1.MUR\AppData\Local\Temp\keystore10848299164616556807.jks -deststoretype pkcs12
     * 
     * GenerateKey using keyTool command:
     * 
     * keytool -genkeypair -alias sivaguru -keyalg RSA -keysize 2048 -validity 730 -keystore javakeystore_keepsecret.jks
     * keytool -list -keystore javakeystore_keepsecret.jks
     * keytool -exportcert -keystore javakeystore_keepsecret.jks -alias sivaguru -file sivaguru.cer
     * 
     */
}
